...
>
  ...
  <div className="max-w-3xl">
    ...
    <div className="space-y-6 text-lg text-zinc-300 leading-relaxed font-light">
      <p>
        Ben <strong>Caner Turan</strong>, karmaşık problemleri kod satırlarıyla çözmeyi seven bir Yazılım Mühendisliği öğrencisiyim. Teknolojiyi sadece bir araç değil, dünyayı daha sürdürülebilir kılacak bir güç olarak görüyorum.
      </p>
      <p>
        Yazılım dünyasında özellikle veri yapıları, algoritmalar ve makine öğrenmesi üzerine odaklanıyorum. Deniz verilerini kullanarak geliştirdiğim balık tahminleme projelerinden, ESP32 ile kurguladığım gömülü sistemlere kadar geniş bir yelpazede "üretmeyi" seviyorum.
      </p>
      <p>
        Kod başında olmadığım zamanlarda, nadir parçalardan oluşan <strong>kaktüs koleksiyonumla</strong> ilgileniyor veya doğayı keşfederek yeni ilham kaynakları arıyorum. Teknoloji ile doğanın kesiştiği noktada, her zaman daha optimize ve estetik çözümler üretmek için çalışıyorum.
      </p>
    </div>
  </div>
</section>
        ...
        <section id="iletisim" className="py-32 bg-zinc-950 px-6 flex flex-col items-center justify-center border-t border-zinc-800">
          ...
          <div className="text-center mb-10 flex flex-col items-center">
            ...
            <p className="text-zinc-400 max-w-lg text-center leading-relaxed">
              İş teklifleri, projeler veya sorularınız için bana bu form üzerinden ulaşabilirsiniz. 
              İncelemek isterseniz CV'm ektedir.
            </p>
          </div>

          {/* Modern CV İndirme/Görüntüleme Kutusu */}
          <a 
          ...
          >
            ...
            <div className="flex flex-col text-left">
              ...
              <span className="text-zinc-400 text-sm">PDF Dosyasını Görüntüle</span>
            </div>
          ...
          {/* Form Alanı (Aynı Kalıyor, Sadece Konumu Ayarlandı) */}
          <div className="w-full max-w-3xl bg-[#14161c] border border-white/5 rounded-[2rem] p-8 md:p-10 shadow-2xl">
            <form className="space-y-8">
              ...
              <div className="flex flex-col">
                ...
                <input 
                  type="text" 
                  placeholder="Kısa bir konu başlığı yazın" 
                  className="bg-[#0b0c10] border border-white/5 rounded-xl p-4 text-zinc-300 focus:outline-none focus:border-purple-500/50 transition-colors placeholder:text-zinc-600" 
                />
              </div>
