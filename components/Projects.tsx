export default function Projects({ lang = 'tr' }: { lang?: 'tr' | 'en' }) {
  
  // Projelerin ve başlıkların her iki dildeki hallerini bir obje içinde tutuyoruz
  const content = {
    tr: {
      sectionTitle: "Öne Çıkan Projelerim",
      items: [
        {
    ...
    en: {
      ...
      items: [
        {
          title: "Fish Prediction Algorithm",
          description: "A Machine Learning (Random Forest) model that predicts fish density in seas using ready and open-source marine data from Copernicus Marine.",
          tech: ["Python", "Machine Learning", "Data Analysis"],
        },
        {
          title: "MiniStream",
          description: "An open-source and independent streaming platform infrastructure. It features a server architecture developed in a Linux environment.",
          tech: ["Linux", "Git", "Backend"],
        },
        {
          title: "Mobile Interface Projects",
          description: "Mobile application interfaces and prototypes designed using View Binding and Fragment transitions on Android Studio.",
          tech: ["Java", "Android Studio", "UI/UX"],
        }
      ]
    }
  ...
  // Seçili dile göre datayı alıyoruz (Hata olursa Türkçe'ye dönüyor)
    ...
    <section className="w-full py-24 bg-zinc-950 text-white flex justify-center border-t border-zinc-800 ">
      <div className="max-w-5xl w-full px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Projeleri seçili dilin items dizisinden dönüyoruz */}
